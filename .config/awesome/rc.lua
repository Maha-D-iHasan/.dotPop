...
-- my-module
local G = require('module.exit-screen')
-- my-Widgets
...
--	  ),
	  ...
	  awful.key(
	    ...
	    'l',
	    function()
	      awful.spawn('systemctl suspend && i3lock')
	    end,
	 ...
	 --),
	  ...
	  awful.key(
	    ...
	    'Print',
	    function()
	      awful.util.spawn_with_shell('flameshot screen -p ~/Pictures -d 5000')
	    end,
	...
	--     'p',
	--     function()
	--       awful.util.spawn_with_shell('flameshot screen -p ~/Pictures')
	--     end,
